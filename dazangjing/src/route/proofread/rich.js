        ...
        <div className="proofread-main">
          <Row className="proofread-main-btngroup">
            ...
            <Col span="11">
              ...
              <Button type="ghost" onClick={this.execCommand.bind(this, 'BackColor', 'purple', true)}>
                广义异体字 <span className="purple-square"></span>
              </Button>
              <Button type="ghost" onClick={this.execCommand.bind(this, 'BackColor', 'blue', true)}>
                广义正字 <span className="blue-square"></span>
              </Button>
              <Button type="ghost" onClick={this.execCommand.bind(this, 'BackColor', 'orange', true)}>
            ...
            <Col span="6">
              <Button type="ghost" onClick={this.execCommand.bind(this, 'BackColor', 'yellow', true)}>
